...
class TestClient:
    ...
    def __init__(self):
        ...
        # self.__tuner_instance = _Client('tt')
        ...
        # self.__tuner_instance.connect('169.254.5.1', 8883, 60)
        ...
        user = 'Simulator3'
        password = '98d7'
        self.__test_topic = 'Device/Tuner/Identity/Status/UnitPresentStatus'
        self.__hmi_instance.username_pw_set(username=user, password=password)
        # instance.connect('192.168.23.3', 1883, 60)
        self.__hmi_instance.connect('192.168.1.102', 1883, 60)
